...
<body>
    ...
    <main class="container bg-light text-dark pt-2 pb-2">        
        <div class="row">
            <div id="carouselBraille" class="carousel carousel-dark slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner mt-2 mb-2">
                    ...
                    <div class="carousel-item active" data-bs-interval="10000">
                        <img src="../IMG/Braille1.jpg" class="d-block w-100 img-fluid rounded" alt="Imagen accesibilidad 1">
                    ...
                    <div class="carousel-item" data-bs-interval="2000">
                        <img src="../IMG/Braille2.jpg" class="d-block w-100 img-fluid rounded" alt="Imagen braille 2">
                        <div class="carousel-caption d-none d-md-block text-white">
                    ...
                    <div class="carousel-item">
                        <img src="../IMG/Braille3.jpg" class="d-block w-100 img-fluid rounded" alt="Imagen braille 3">
                        <div class="carousel-caption d-none d-md-block text-white">

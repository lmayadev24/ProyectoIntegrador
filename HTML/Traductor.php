...
<body>
    ...
    <main class="container">
        <div class="row g-3 d-flex justify-content-around">
            <div class="mb-3 col-12 col-md-6">
                ...
                <textarea type="text" class="form-control textarea-estilizado" id="textSpanish" placeholder="Texto en Español"></textarea>
            </div>
            <div class="mb-3 col-12 col-md-6">
                <label for="textBraille" class="form-label">Braille</label>
                <textarea type="text" class="form-control textarea-estilizado" id="textBraille" placeholder="Texto en Braille" disabled></textarea>
            </div>
        </div>
        <div class="mb-3 d-flex justify-content-center">
            <button class="btn btn-primary" type="submit" onclick="Traducir(document.getElementById('textSpanish'),document.getElementById('textBraille'))">Traducir</button>
        </div>
    </main>
    ...
    <div class="offcanvas offcanvas-end" data-bs-scroll="true" tabindex="-1" id="offcanvasLogin" aria-labelledby="offcanvasWithBothOptionsLabel">
        ...
        <div class="offcanvas-body">
            <div >
                <form action="../PHP/login.php" method="POST" onsubmit="return valUser(this.elements['usuario'].value, this.elements['contrasena'].value);" class="p-3 border rounded bg-light shadow-sm">
